...
addon_id        = 'plugin.video.Universe-Movies'
...
baseurl         = 'http://worldkodi.com/Universe-Movies/Xml/Base.xml'
adultpass       = selfAddon.getSetting('password')
metaset         = selfAddon.getSetting('enable_meta')
messagetext     = 'http://worldkodi.com/Universe-Movies/Xml/Message.txt'
livematches     = ''
#RUNNER 			= base64.b64decode(b'aHR0cDovL3NpbXRlY2gubmV0MTYubmV0L3lvdXR1YmUucGhwP2lkPQ==')
SEARCH_LIST     = base64.b64decode(b'aHR0cDovL3dvcmxka29kaS5jb20vVW5pdmVyc2UtTW92aWVzL1htbC9TZWFyY2gueG1s')
...
def SCRAPE_BIGSPORTS(url):
	...
	try:
		...
		dialog.ok("Universe Movies", "Sorry, we could not find any live links at the moment. Please try again later.")
		quit()
...
def SCRAPE_MAMAHD_SPORTS_CHANNELS(url):
    ...
    try:
        ...
        dialog.ok("Universe Movies", "And The Offside Flag Is Up No Link Available")
        quit()
